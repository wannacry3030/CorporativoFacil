    ...
    <body class="empresas">
        ...
        <article>
            ...
            <section>
                ...
                <?php                
                    $empresas = new Ler();
                    $empresas->consultaManual("SELECT *,fkestado,em.id AS id_empresa FROM empresas em LEFT JOIN 
                             estados e ON em.fkestado = e.id");
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="valores"><?= $uf;?></td>
                        <td class="valores"><?= $descricao;?></td>
                        <td class="valores">
                            <a href="editar_empresa.php?r=<?= $id*1079*2098*9990;?>">editar</a>
                            <a href="editar_empresa.php?excluir=<?= $id*1079*2098*9990;?>" class="botao_excluir">excluir.</a>
                        </td>
                    </tr>
                </table>
                <?php      
